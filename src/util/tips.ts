...
export function expertTipsLines(): string[] {
  return [
    `Forge expert tips`,
    `  Live mid-run:  /improve  ·  /hooks init  ·  /cycle 0|1  ·  /max-waves N|off  ·  /ulw-off  ·  /budget N|off  ·  /notify on  ·  /plan  ·  /build  ·  /model  ·  /pause  ·  /unpause  ·  /done  ·  /status  ·  /checkpoint  ·  /tasks kill|log  ·  get_task_output wait=`,
    ...
    `  Worktrees:      doctor/status show linked worktree · spawn_subagent isolation=worktree auto-lands (FORGE_SUBAGENT_LAND=auto|keep|discard) · FORGE_SUBAGENT_KEEP_WORKTREE=1 · one session per worktree`,
