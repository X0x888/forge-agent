...
export function expertTipsLines(): string[] {
  return [
    ...
    `  Less steering:  handoff-guard blocks "shall I continue?" · proof-claim blocks "tests pass" without a run · soft TodoGate outside ULW · /done winds ULW+goal · state your reading first · safety valves flip ULW to LAST`,
