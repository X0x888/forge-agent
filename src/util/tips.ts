...
export function expertTipsLines(): string[] {
  return [
    ...
    `  Accounts:      forge accounts list|switch|auto-switch  ·  forge login --add  ·  /accounts  ·  /auth  ·  auto-switch on 429/quota + plan threshold  ·  /fallback after 429/5xx (off by default; floor grok-4.5 high — never a weaker model)`,
