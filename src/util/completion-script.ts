...
export function shellCompletionScript(shell: string): string {
  ...
  if (normalized === "zsh") {
    return [
      ...
      "          ;;",
      "        -p|--provider)",
      "          _values 'provider' xai anthropic openai openrouter deepseek google copilot custom grok claude sonnet opus haiku gpt oai chatgpt gemini bard or router ds deepseek github github-copilot gh-copilot",
      "          return",
      "          ;;",
      "      esac",
      "      case $line[1] in",
  ...
  if (normalized === "fish") {
    return [
      ...
      'complete -c forge -l provider -d "Provider" -x -a "xai anthropic openai openrouter deepseek google copilot custom grok claude sonnet opus haiku gpt oai chatgpt gemini bard or router ds deepseek github github-copilot gh-copilot"',
      ...
      'complete -c forge -n "__fish_seen_subcommand_from run" -l provider -d "Provider" -x -a "xai anthropic openai openrouter deepseek google copilot custom grok claude sonnet opus haiku gpt oai chatgpt gemini bard or router ds deepseek github github-copilot gh-copilot"',
  ...
  return [
    ...
    "      ;;",
    "    -p|--provider)",
    '      COMPREPLY=( $(compgen -W "xai anthropic openai openrouter deepseek google copilot custom grok claude sonnet opus haiku gpt oai chatgpt gemini bard or router ds deepseek github github-copilot gh-copilot" -- "$cur") )',
    "      return",
    "      ;;",
    '    --keep)',
