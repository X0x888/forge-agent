...
| `read_file` | Default **1000 lines**, long-line clip, binary refuse, directory list, path-not-found hints; soft size hint ≥2 MiB; **past-EOF** offset is explicit (not empty-file). |
