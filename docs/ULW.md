...
One item: <required when Items has one entry: why the other Considered candidates are a different job or leave-it, not sequels>
Out of scope:
- <a different job or a lease limit — not the rest of this Looked: class parked for cycle N+1>
