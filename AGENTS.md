...
- `src/session/request-prune.ts` — outbound working-set prune (default **off** until 180k so the prefix can cache; `FORGE_REQUEST_PRUNE=1` legacy every-round)
